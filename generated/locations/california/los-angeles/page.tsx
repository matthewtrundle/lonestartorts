...
export const metadata: Metadata = {
  title: 'Authentic Texas Tortillas Delivered to Los Angeles | Lonestar Tortillas',
  ...
  keywords: 'tortillas Los Angeles, Texas tortillas California, H-E-B tortillas delivery, authentic Mexican tortillas Los Angeles, fresh tortillas shipped',
  alternates: {
        ...
        <article className="container mx-auto px-6 py-12 max-w-4xl">
          ...
          <section className="bg-charcoal-950 text-cream-50 p-8 rounded-lg mt-12 text-center">
            ...
            <p className="text-lg mb-6 text-cream-200">
              Order authentic H-E-B® tortillas delivered fresh to Los Angeles.
            </p>
            <Link
              href="/shop"
