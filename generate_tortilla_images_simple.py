...
Simple version with sequential generation to avoid event loop issues.
"""
import sys
import os
...
print("🌮 Generating remaining images for Tortilla Rodeo Co...")

for i, product in enumerate(products):
    try:
        print(f"\n📸 Generating image {i+1}/{len(products)}: {product['name']}")
