...
export const restaurantContent: Record<string, RestaurantContent> = {
  'food-trucks': {
    ...
    trustSignals: [
      ...
      },
      {
        ...
        description: 'Restaurant-grade quality',
      },
    ],
    testimonials: [],
    finalCTA: {
      headline: 'Join Food Trucks Winning with H-E-B',
      subhead: 'Start serving Texas\' favorite tortillas with Smart Shipping nationwide.',
      buttonText: 'Start Your Order',
    },
    seo: {
      title: 'Premium H-E-B Tortillas for Food Trucks | Lonestar Tortillas',
      description: 'Elevate your food truck menu with authentic H-E-B tortillas. Restaurant-grade quality, consistent results, delivered fresh with Smart Shipping nationwide.',
  ...
  bbq: {
    ...
    painPoints: [
      ...
      },
      {
        ...
        description: 'Bring authentic Texas BBQ to your out-of-state customers—including the tortillas',
        icon: 'MapPin',
      },
    ],
    solution: {
    ...
    finalCTA: {
      ...
      subhead: 'Give your brisket the tortilla it deserves with Smart Shipping nationwide.',
      buttonText: 'Start Your Order',
    },
    seo: {
      title: 'H-E-B Tortillas for BBQ Restaurants | Lonestar Tortillas',
      description: 'Elevate your BBQ tacos with authentic H-E-B flour tortillas. Strong enough for loaded brisket, authentic enough for Texas. Smart Shipping nationwide.',
  ...
  mexican: {
    ...
    finalCTA: {
      ...
      subhead: 'Serve tortillas your abuela would approve of with Smart Shipping nationwide.',
      buttonText: 'Start Your Order',
    },
    seo: {
      title: 'Authentic H-E-B Tortillas for Mexican Restaurants | Lonestar Tortillas',
      description: 'Elevate your Mexican restaurant with authentic H-E-B flour tortillas. Traditional flavor, consistent quality, loved by Texans. Smart Shipping nationwide.',
  ...
  'tex-mex': {
    ...
    finalCTA: {
      ...
      subhead: 'Serve fajitas that stay together with Smart Shipping nationwide.',
      buttonText: 'Start Your Order',
    },
    seo: {
      title: 'H-E-B Tortillas for Tex-Mex Restaurants | Lonestar Tortillas',
      description: 'Elevate your Tex-Mex restaurant with H-E-B flour tortillas. Perfect for fajitas, strong enough for high volume. Smart Shipping nationwide.',
  ...
  'taco-shops': {
    ...
    finalCTA: {
      ...
      subhead: 'Make your tacos unforgettable with Smart Shipping nationwide.',
      buttonText: 'Start Your Order',
    },
    seo: {
      title: 'H-E-B Tortillas for Taco Shops & Taquerias | Lonestar Tortillas',
      description: 'Elevate your taco shop with authentic H-E-B flour tortillas. Quality that differentiates, consistency that builds loyalty. Smart Shipping nationwide.',
  ...
  catering: {
    ...
    finalCTA: {
      ...
      subhead: 'Deliver events your clients will remember with Smart Shipping nationwide.',
      buttonText: 'Start Your Order',
    },
    seo: {
      title: 'H-E-B Tortillas for Catering Companies | Lonestar Tortillas',
      description: 'Elevate your catering with reliable H-E-B flour tortillas. 60-day shelf life, consistent quality at scale. Smart Shipping nationwide.',
  ...
  breakfast: {
    ...
    solution: {
      ...
      features: [
        ...
        },
        {
          ...
          description: 'H-E-B tortillas bring Texas breakfast taco authenticity to your location. Give your customers the real Texas experience.',
          icon: 'Star',
        },
      ],
    ...
    finalCTA: {
      ...
      subhead: 'Serve breakfast tacos worth waking up for with Smart Shipping nationwide.',
      buttonText: 'Start Your Order',
    },
    seo: {
      title: 'H-E-B Tortillas for Breakfast & Brunch Restaurants | Lonestar Tortillas',
      description: 'Elevate your breakfast tacos with authentic H-E-B flour tortillas. Perfect for the morning rush, loved by Texans. Smart Shipping nationwide.',
