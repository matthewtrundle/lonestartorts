  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. Lonestar Tortillas ships authentic H-E-B Bakery tortillas to all 50 US states. FREE shipping on orders $80+, or flat $14.99 shipping on smaller orders. We are an independent reseller based in Austin, Texas. Orders ship via USPS Priority Mail with 2-3 business day delivery.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Shipping is FREE on orders $80+. Orders under $80 ship for a flat $14.99. We ship via USPS Priority Mail with 2-3 business day delivery.',
      },
    },
    {
      '@type': 'Question',
...
const webPageSchema = {
  ...
  description: 'Lonestar Tortillas ships H-E-B tortillas to all 50 US states. FREE shipping on orders $80+, flat $14.99 under $80. We ship Tuesdays for maximum freshness. 2-3 day delivery via USPS Priority Mail.',
