  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. Lonestar Tortillas ships authentic H-E-B Bakery tortillas to all 50 US states. FREE shipping on every order ($80 minimum). We are an independent reseller based in Austin, Texas. Orders ship via USPS Priority Mail with 2-3 business day delivery.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Shipping is FREE on every order ($80 minimum order). We ship via USPS Priority Mail with 2-3 business day delivery.',
      },
    },
    {
      '@type': 'Question',
...
const webPageSchema = {
  ...
  description: 'Lonestar Tortillas ships H-E-B tortillas to all 50 US states. FREE shipping on every order ($80 minimum order). We ship Tuesdays for maximum freshness. 2-3 day delivery via USPS Priority Mail.',
