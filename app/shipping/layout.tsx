...
export const metadata: Metadata = {
  ...
  description: 'Order authentic H-E-B tortillas for delivery anywhere in the US. FREE shipping on orders $80+, flat $14.99 under $80. 2-3 day delivery via USPS Priority Mail. Ships Tuesdays for maximum freshness.',
