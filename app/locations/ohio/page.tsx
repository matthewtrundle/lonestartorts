...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes! We offer free shipping on orders $80+ to Ohio and all other US states. All orders ship free with our $80 minimum order. We use USPS Priority Mail to ensure fast, reliable delivery to every address in Ohio.',
      },
    },
    {
      '@type': 'Question',
