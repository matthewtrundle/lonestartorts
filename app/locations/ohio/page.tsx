...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes! We offer free shipping on orders $60+ to Ohio and all other US states. For smaller orders, our flat-rate shipping is $12.99. We use USPS Priority Mail to ensure fast, reliable delivery to every address in Ohio.',
      },
    },
    {
      '@type': 'Question',
        ...
        <section className="bg-white p-8 rounded-lg shadow-md mb-12">
          ...
          <div className="space-y-4">
            ...
            <details className="group border border-charcoal-200 rounded-lg overflow-hidden">
              ...
              <div className="p-4 bg-white border-t border-charcoal-200">
                <p className="text-charcoal-700 leading-relaxed">
                  Yes! We offer free shipping on orders $60+ to Ohio and all other US states.
