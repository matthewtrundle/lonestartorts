...
export const metadata: Metadata = {
  title: 'H-E-B Tortillas to Cleveland',
  description: 'Get authentic H-E-B Texas tortillas shipped to Cleveland, Ohio. Fast 2-3 day shipping.',
  alternates: { canonical: 'https://lonestartortillas.com/locations/ohio/cleveland' },
}
    ...
    <div className="min-h-screen bg-gradient-to-b from-cream-50 to-masa-50">
      <header className="bg-charcoal-950 text-cream-50 py-12">
        <div className="container mx-auto px-6 max-w-6xl">
          <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Locations', href: '/locations' }, { label: 'Ohio', href: '/locations/ohio' }, { label: 'Cleveland' }]} className="mb-6 text-cream-300" />
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Authentic Texas Tortillas Delivered to Cleveland</h1>
          <p className="text-xl text-cream-200 max-w-3xl">Get fresh H-E-B tortillas shipped directly to Northeast Ohio.</p>
      ...
      <section className="max-w-6xl mx-auto px-6 py-8"><div className="relative w-full h-[300px] md:h-[400px] rounded-xl overflow-hidden shadow-lg"><Image src="/images/generated/hero-tortillas.webp" alt="Fresh tortillas delivered to Cleveland" fill sizes="(max-width: 1152px) 100vw, 1152px" className="object-cover" priority /></div></section>
      <article className="container mx-auto px-6 py-12 max-w-4xl">
        <section className="prose prose-lg max-w-none mb-12">
          <h2 className="text-3xl font-bold text-charcoal-950 mb-6">Why Cleveland Loves Texas Tortillas</h2>
          <p className="text-charcoal-700 leading-relaxed">Cleveland's healthcare and tech industries draw talent from across the nation. For Texans who've traded the Lone Star for Lake Erie, authentic H-E-B tortillas are a taste of home. We deliver to Cleveland, the suburbs, and all of Cuyahoga County.</p>
          ...
          <p className="text-charcoal-700 leading-relaxed mt-4">Our customers in Cleveland tell us they love the convenience of having authentic Texas tortillas delivered right to their door. No more settling for grocery store alternatives when you can enjoy the real thing.</p>
        </section>
        <section className="bg-sunset-50 border-l-4 border-sunset-500 p-6 rounded-r-lg mb-12">
          <h2 className="text-xl font-bold text-charcoal-950 mb-2">Cleveland Shipping Details</h2>
        ...
        <LocationFAQ city="Cleveland" state="Ohio" />
        ...
        <section className="bg-charcoal-950 text-cream-50 p-8 rounded-lg mt-12 text-center">
          <h2 className="text-2xl font-bold mb-4">Ready to Taste Texas in Cleveland?</h2>
