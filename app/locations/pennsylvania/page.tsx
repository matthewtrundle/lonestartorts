...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'How long does shipping to Pennsylvania take?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Orders to Pennsylvania typically arrive within 2-3 business days via USPS Priority Mail. We ship on Tuesdays, and order by Monday 9 PM CT to ship Tuesday. During peak seasons like holidays, delivery may take an extra day.',
      },
    },
    {
      '@type': 'Question',
      name: 'Are the tortillas fresh when they arrive in Pennsylvania?',
      acceptedAnswer: {
        '@type': 'Answer',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes! We offer free shipping on orders $80+ to Pennsylvania and all other US states. All orders ship free with our $80 minimum order. We use USPS Priority Mail to ensure fast, reliable delivery to every address in Pennsylvania.',
      },
    },
    {
      '@type': 'Question',
      name: 'What types of H-E-B tortillas can I order to Pennsylvania?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'We ship the full range of H-E-B tortillas to Pennsylvania: corn tortillas (perfect for tacos and enchiladas), flour tortillas (great for burritos and quesadillas), and butter tortillas (the rich, buttery Texas favorite that\'s perfect for breakfast tacos). All varieties ship fresh and arrive ready to enjoy.',
      },
    },
    {
      '@type': 'Question',
...
export default function PennsylvaniaPage() {
  return (
    <>
      ...
      <section className="max-w-6xl mx-auto px-6 py-8"><div className="relative w-full h-[300px] md:h-[400px] rounded-xl overflow-hidden shadow-lg"><Image src="/images/generated/hero-tortillas.webp" alt="Fresh tortillas delivered to Pennsylvania" fill sizes="(max-width: 1152px) 100vw, 1152px" className="object-cover" priority /></div></section>
