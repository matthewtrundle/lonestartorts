...
export const metadata: Metadata = {
  ...
  description: 'Get authentic H-E-B Texas tortillas shipped to Scottsdale, Arizona. Fast 2-3 day shipping.',
  keywords: 'tortillas Scottsdale, Texas tortillas Scottsdale AZ, H-E-B tortillas delivery',
  alternates: { canonical: 'https://lonestartortillas.com/locations/arizona/scottsdale' },
}
...
export default function ScottsdalePage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-cream-50 to-masa-50">
      ...
      <section className="max-w-6xl mx-auto px-6 py-8"><div className="relative w-full h-[300px] md:h-[400px] rounded-xl overflow-hidden shadow-lg"><Image src="/images/generated/hero-tortillas.webp" alt="Fresh tortillas delivered to Scottsdale" fill className="object-cover" priority /></div></section>
      <article className="container mx-auto px-6 py-12 max-w-4xl">
        <section className="prose prose-lg max-w-none mb-12">
          <h2 className="text-3xl font-bold text-charcoal-950 mb-6">Why Scottsdale Loves Texas Tortillas</h2>
          <p className="text-charcoal-700 leading-relaxed">Scottsdale's culinary scene attracts food lovers who demand quality. H-E-B tortillas bring authentic Texas flavor to elevate home cooking in this upscale community.</p>
          ...
          <p className="text-charcoal-700 leading-relaxed mt-4">Our customers in Scottsdale tell us they love the convenience of having authentic Texas tortillas delivered right to their door. No more settling for grocery store alternatives when you can enjoy the real thing.</p>
        </section>
        <section className="bg-sunset-50 border-l-4 border-sunset-500 p-6 rounded-r-lg mb-12">
          <h2 className="text-xl font-bold text-charcoal-950 mb-2">Scottsdale Shipping Details</h2>
        ...
        <LocationFAQ city="Scottsdale" state="Arizona" />
        ...
        <section className="bg-charcoal-950 text-cream-50 p-8 rounded-lg mt-12 text-center">
          <h2 className="text-2xl font-bold mb-4">Ready to Taste Texas in Scottsdale?</h2>
