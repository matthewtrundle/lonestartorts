...
export default function FortCollinsPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-cream-50 to-masa-50">
      ...
      <section className="max-w-6xl mx-auto px-6 py-8"><div className="relative w-full h-[300px] md:h-[400px] rounded-xl overflow-hidden shadow-lg"><Image src="/images/generated/hero-tortillas.webp" alt="Fresh tortillas delivered to Fort Collins" fill sizes="(max-width: 1152px) 100vw, 1152px" className="object-cover" priority /></div></section>
      <article className="container mx-auto px-6 py-12 max-w-4xl">
        <section className="prose prose-lg max-w-none mb-12">
          ...
          <p className="text-charcoal-700 leading-relaxed mt-4">Our customers in Fort Collins tell us they love the convenience of having authentic Texas tortillas delivered right to their door. No more settling for grocery store alternatives when you can enjoy the real thing.</p>
        </section>
        ...
        <LocationFAQ city="Fort Collins" state="Colorado" />
