...
export const metadata: Metadata = {
  ...
  description: 'Get authentic H-E-B Texas tortillas shipped to Sterling Heights, Michigan. Fast 2-3 day shipping.',
  alternates: { canonical: 'https://lonestartortillas.com/locations/michigan/sterling-heights' },
}
    ...
    <div className="min-h-screen bg-gradient-to-b from-cream-50 to-masa-50">
      <header className="bg-charcoal-950 text-cream-50 py-12">
        <div className="container mx-auto px-6 max-w-6xl">
          <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Locations', href: '/locations' }, { label: 'Michigan', href: '/locations/michigan' }, { label: 'Sterling Heights' }]} className="mb-6 text-cream-300" />
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Authentic Texas Tortillas Delivered to Sterling Heights</h1>
          <p className="text-xl text-cream-200 max-w-3xl">Get fresh H-E-B tortillas shipped directly to Metro Detroit.</p>
      ...
      <section className="max-w-6xl mx-auto px-6 py-8"><div className="relative w-full h-[300px] md:h-[400px] rounded-xl overflow-hidden shadow-lg"><Image src="/images/generated/hero-tortillas.webp" alt="Fresh tortillas delivered to Sterling Heights" fill sizes="(max-width: 1152px) 100vw, 1152px" className="object-cover" priority /></div></section>
