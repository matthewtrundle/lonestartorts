    ...
    <div className="min-h-screen bg-gradient-to-b from-cream-50 to-masa-50">
      <header className="bg-charcoal-950 text-cream-50 py-12">
        <div className="container mx-auto px-6 max-w-6xl">
          <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Locations', href: '/locations' }, { label: 'Georgia', href: '/locations/georgia' }, { label: 'Savannah' }]} className="mb-6 text-cream-300" />
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Authentic Texas Tortillas Delivered to Savannah</h1>
          <p className="text-xl text-cream-200 max-w-3xl">Get fresh H-E-B tortillas shipped directly to the Hostess City.</p>
      ...
      <article className="container mx-auto px-6 py-12 max-w-4xl">
        <section className="prose prose-lg max-w-none mb-12">
          ...
          <p className="text-charcoal-700 leading-relaxed">Savannah's historic charm and foodie scene attract visitors and transplants from everywhere—including Texas. With nearby Hunter Army Airfield bringing military families from across the country, the demand for authentic Texas flavors is real. From the Historic District to the Islands, we deliver H-E-B tortillas to coastal Georgia.</p>
          ...
          <p className="text-charcoal-700 leading-relaxed mt-4">Our customers in Savannah tell us they love the convenience of having authentic Texas tortillas delivered right to their door. No more settling for grocery store alternatives when you can enjoy the real thing.</p>
        </section>
        <section className="bg-sunset-50 border-l-4 border-sunset-500 p-6 rounded-r-lg mb-12">
          <h2 className="text-xl font-bold text-charcoal-950 mb-2">Savannah Shipping Details</h2>
        ...
        <LocationFAQ city="Savannah" state="Georgia" />
        ...
        <section className="bg-charcoal-950 text-cream-50 p-8 rounded-lg mt-12 text-center">
          <h2 className="text-2xl font-bold mb-4">Ready to Taste Texas in Savannah?</h2>
