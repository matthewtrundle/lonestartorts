...
export const metadata: Metadata = {
  title: 'Authentic Texas Tortillas Delivered to Moreno Valley | Lonestar Tortillas',
...
const localBusinessSchema = {
  '@context': 'https://schema.org',
  '@type': 'LocalBusiness',
  name: 'Lonestar Tortillas - Moreno Valley Delivery',
  description: 'Authentic Texas tortillas delivered to Moreno Valley and the Inland Empire',
  areaServed: {
    '@type': 'City',
    name: 'Moreno Valley',
    containedInPlace: {
  ...
  url: 'https://lonestartortillas.com/locations/california/moreno-valley',
  priceRange: '$$',
}
