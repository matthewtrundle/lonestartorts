...
export const metadata: Metadata = {
  title: 'Authentic Texas Tortillas Delivered to Long Beach | Lonestar Tortillas',
  description: 'Get authentic H-E-B Texas tortillas shipped directly to Long Beach, California. Fresh flour & corn tortillas for tacos, burritos & more. Fast shipping, premium quality.',
  keywords: 'tortillas Long Beach, Texas tortillas California, H-E-B tortillas delivery, authentic Mexican tortillas Long Beach, fresh tortillas shipped',
  alternates: {
    canonical: 'https://lonestartortillas.com/locations/california/long-beach',
  },
  openGraph: {
    title: 'Texas Tortillas Delivered to Long Beach | Lonestar Tortillas',
    description: 'Authentic H-E-B tortillas shipped fresh to Long Beach. Experience the taste of Texas.',
    type: 'website',
  },
}
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'How long does shipping take to Long Beach?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Most orders arrive in 2-3 business days. We ship via refrigerated carrier to ensure freshness.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Keep them refrigerated and use within 7 days of arrival. Freeze extras for up to 3 months! [Link to: /guides/how-to-store-tortillas] Detailed storage guide here.',
      },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'No minimum! Order one pack or ten – we’re happy to serve you.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Absolutely! We deliver to Los Angeles, Anaheim, Irvine, and statewide. We also ship to Arizona and Nevada.',
      },
    }
  ],
}
...
const localBusinessSchema = {
  '@context': 'https://schema.org',
  '@type': 'LocalBusiness',
  name: 'Lonestar Tortillas - Long Beach Delivery',
  description: 'Authentic Texas tortillas delivered to Long Beach, California',
  areaServed: {
    '@type': 'City',
    name: 'Long Beach',
    containedInPlace: {
  ...
  url: 'https://lonestartortillas.com/locations/california/long-beach',
        ...
        <header className="bg-charcoal-950 text-cream-50 py-12">
          <div className="container mx-auto px-6 max-w-6xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              Authentic Texas Tortillas Delivered to Long Beach
            </h1>
            <p className="text-xl text-cream-200 max-w-3xl">
              Get fresh H-E-B tortillas shipped directly to your door in Long Beach, California. Experience the authentic taste of Texas.
            </p>
            <Link
              href="/shop"
        ...
        <article className="container mx-auto px-6 py-12 max-w-4xl prose prose-lg">
          ...
          <section className="bg-charcoal-950 text-cream-50 p-8 rounded-lg mt-12 text-center not-prose">
            ...
            <p className="text-lg mb-6 text-cream-200">
              Order authentic H-E-B tortillas delivered fresh to Long Beach.
            </p>
            <Link
              href="/shop"
