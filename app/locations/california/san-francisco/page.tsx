...
export const metadata: Metadata = {
  title: 'Authentic Texas Tortillas Delivered to San Francisco | Lonestar Tortillas',
  description: 'Get authentic H-E-B Texas tortillas shipped directly to San Francisco, California. Fresh flour & corn tortillas for tacos, burritos & more. Fast shipping, premium quality.',
  keywords: 'tortillas San Francisco, Texas tortillas California, H-E-B tortillas delivery, authentic Mexican tortillas San Francisco, fresh tortillas shipped',
  alternates: {
    canonical: 'https://lonestartortillas.com/locations/california/san-francisco',
  },
  openGraph: {
    title: 'Texas Tortillas Delivered to San Francisco | Lonestar Tortillas',
    description: 'Authentic H-E-B tortillas shipped fresh to San Francisco. Experience the taste of Texas.',
    type: 'website',
  },
}
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Keep them refrigerated for up to 2 weeks or freeze for 3 months. Always reheat on a dry skillet for that fresh-off-the-griddle texture! [Link to: /guides/how-to-store-tortillas]',
      },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'No minimum! Order one pack or ten—we’ve got you covered.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes! We deliver to Los Angeles, Sacramento, San Diego, and everywhere between. We also ship to Oregon and Nevada.',
      },
    }
  ],
}
...
const localBusinessSchema = {
  '@context': 'https://schema.org',
  '@type': 'LocalBusiness',
  name: 'Lonestar Tortillas - San Francisco Delivery',
  description: 'Authentic Texas tortillas delivered to San Francisco, California',
  areaServed: {
    '@type': 'City',
    name: 'San Francisco',
    containedInPlace: {
  ...
  url: 'https://lonestartortillas.com/locations/california/san-francisco',
        ...
        <header className="bg-charcoal-950 text-cream-50 py-12">
          <div className="container mx-auto px-6 max-w-6xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              Authentic Texas Tortillas Delivered to San Francisco
            </h1>
            <p className="text-xl text-cream-200 max-w-3xl">
              Get fresh H-E-B tortillas shipped directly to your door in San Francisco, California. Experience the authentic taste of Texas.
            </p>
            <Link
              href="/shop"
