...
export const metadata: Metadata = {
  title: 'Authentic Texas Tortillas Delivered to Sacramento | Lonestar Tortillas',
  description: 'Get authentic H-E-B Texas tortillas shipped directly to Sacramento, California. Fresh flour & corn tortillas for tacos, burritos & more. Fast shipping, premium quality.',
  keywords: 'tortillas Sacramento, Texas tortillas California, H-E-B tortillas delivery, authentic Mexican tortillas Sacramento, fresh tortillas shipped',
  alternates: {
    canonical: 'https://lonestartortillas.com/locations/california/sacramento',
  },
  openGraph: {
    title: 'Texas Tortillas Delivered to Sacramento | Lonestar Tortillas',
    description: 'Authentic H-E-B tortillas shipped fresh to Sacramento. Experience the taste of Texas.',
    type: 'website',
  },
}
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Most orders arrive in 2–3 business days. We ship same-day if ordered by 12 PM CT!',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Keep them fresh by refrigerating in their sealed bag or freezing for up to 3 months. [Link to: /guides/how-to-store-tortillas]',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Our corn tortillas are 100% gluten-free. Flour tortillas contain wheat.',
      },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes! We deliver statewide, including San Francisco, Los Angeles, and everywhere between.',
      },
    }
  ],
}
...
const localBusinessSchema = {
  '@context': 'https://schema.org',
  '@type': 'LocalBusiness',
  name: 'Lonestar Tortillas - Sacramento Delivery',
  description: 'Authentic Texas tortillas delivered to Sacramento, California',
  areaServed: {
    '@type': 'City',
    name: 'Sacramento',
    containedInPlace: {
  ...
  url: 'https://lonestartortillas.com/locations/california/sacramento',
        ...
        <header className="bg-charcoal-950 text-cream-50 py-12">
          <div className="container mx-auto px-6 max-w-6xl">
            ...
            <p className="text-xl text-cream-200 max-w-3xl">
              Get fresh H-E-B tortillas shipped directly to your door in Sacramento, California. Experience the authentic taste of Texas.
            </p>
            <Link
              href="/shop"
        ...
        <article className="container mx-auto px-6 py-12 max-w-4xl prose prose-lg">
          ...
          <section className="bg-charcoal-950 text-cream-50 p-8 rounded-lg mt-12 text-center not-prose">
            ...
            <p className="text-lg mb-6 text-cream-200">
              Order authentic H-E-B tortillas delivered fresh to Sacramento.
            </p>
            <Link
              href="/shop"
          ...
          <section className="mt-12 not-prose">
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="/locations/california/san-francisco" className="px-4 py-2 bg-white border border-charcoal-200 rounded-lg text-charcoal-700 hover:border-sunset-500 hover:text-sunset-600 transition-colors text-sm">
                San Francisco
              </Link>
              <Link href="/locations/california/stockton" className="px-4 py-2 bg-white border border-charcoal-200 rounded-lg text-charcoal-700 hover:border-sunset-500 hover:text-sunset-600 transition-colors text-sm">
                Stockton
              </Link>
              <Link href="/locations/california/fresno" className="px-4 py-2 bg-white border border-charcoal-200 rounded-lg text-charcoal-700 hover:border-sunset-500 hover:text-sunset-600 transition-colors text-sm">
                Fresno
              </Link>
            </div>
          </section>
