...
export const metadata: Metadata = {
  title: 'Authentic Texas Tortillas Delivered to Riverside | Lonestar Tortillas',
  description: 'Get authentic H-E-B Texas tortillas shipped directly to Riverside, California. Fresh flour & corn tortillas for tacos, burritos & more. Fast shipping, premium quality.',
  keywords: 'tortillas Riverside, Texas tortillas California, H-E-B tortillas delivery, authentic Mexican tortillas Riverside, fresh tortillas shipped',
  alternates: {
    canonical: 'https://lonestartortillas.com/locations/california/riverside',
  },
  openGraph: {
    title: 'Texas Tortillas Delivered to Riverside | Lonestar Tortillas',
    description: 'Authentic H-E-B tortillas shipped fresh to Riverside. Experience the taste of Texas.',
    type: 'website',
  },
}
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'How long does shipping take to Riverside?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Most orders arrive in 2-3 days via priority shipping. We ship Mondays-Wednesdays to avoid weekend delays.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Keep them refrigerated for up to 2 weeks or freeze for 3 months. Reheat on a dry skillet for that just-made taste. [Link to: /guides/how-to-store-tortillas]',
      },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes! We deliver statewide, including Los Angeles, San Diego, and Fresno.',
      },
    }
  ],
}
...
const localBusinessSchema = {
  '@context': 'https://schema.org',
  '@type': 'LocalBusiness',
  name: 'Lonestar Tortillas - Riverside Delivery',
  description: 'Authentic Texas tortillas delivered to Riverside, California',
  areaServed: {
    '@type': 'City',
    name: 'Riverside',
    containedInPlace: {
  ...
  url: 'https://lonestartortillas.com/locations/california/riverside',
        ...
        <header className="bg-charcoal-950 text-cream-50 py-12">
          <div className="container mx-auto px-6 max-w-6xl">
            ...
            <p className="text-xl text-cream-200 max-w-3xl">
              Get fresh H-E-B tortillas shipped directly to your door in Riverside, California. Experience the authentic taste of Texas.
            </p>
            <Link
              href="/shop"
        ...
        <article className="container mx-auto px-6 py-12 max-w-4xl prose prose-lg">
          ...
          <section className="bg-charcoal-950 text-cream-50 p-8 rounded-lg mt-12 text-center not-prose">
            ...
            <p className="text-lg mb-6 text-cream-200">
              Order authentic H-E-B tortillas delivered fresh to Riverside.
            </p>
            <Link
              href="/shop"
          ...
          <section className="mt-12 not-prose">
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="/locations/california/san-bernardino" className="px-4 py-2 bg-white border border-charcoal-200 rounded-lg text-charcoal-700 hover:border-sunset-500 hover:text-sunset-600 transition-colors text-sm">
                San Bernardino
              </Link>
