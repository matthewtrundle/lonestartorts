...
export const metadata: Metadata = {
  title: 'Authentic Texas Tortillas Delivered to San Jose | Lonestar Tortillas',
  description: 'Get authentic H-E-B Texas tortillas shipped directly to San Jose, California. Fresh flour & corn tortillas for tacos, burritos & more. Fast shipping, premium quality.',
  keywords: 'tortillas San Jose, Texas tortillas California, H-E-B tortillas delivery, authentic Mexican tortillas San Jose, fresh tortillas shipped',
  alternates: {
    canonical: 'https://lonestartortillas.com/locations/california/san-jose',
  },
  openGraph: {
    title: 'Texas Tortillas Delivered to San Jose | Lonestar Tortillas',
    description: 'Authentic H-E-B tortillas shipped fresh to San Jose. Experience the taste of Texas.',
    type: 'website',
  },
}
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Keep them refrigerated for up to 7 days or freeze for 3 months. See our storage guide [Link to: /guides/how-to-store-tortillas] for tips.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Our corn tortillas are! Flour tortillas contain wheat.',
      },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Absolutely! We deliver to San Francisco, Oakland, Los Angeles, and statewide.',
      },
    }
  ],
}
        ...
        <article className="container mx-auto px-6 py-12 max-w-4xl prose prose-lg">
          ...
          <section className="bg-charcoal-950 text-cream-50 p-8 rounded-lg mt-12 text-center not-prose">
            ...
            <p className="text-lg mb-6 text-cream-200">
              Order authentic H-E-B tortillas delivered fresh to San Jose.
            </p>
            <Link
              href="/shop"
