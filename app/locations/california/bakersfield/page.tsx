...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://lonestartortillas.com/locations/california/bakersfield',
  },
  openGraph: {
    title: 'Texas Tortillas Delivered to Bakersfield | Lonestar Tortillas',
    description: 'Authentic H-E-B tortillas shipped fresh to Bakersfield. Experience the taste of Texas.',
    type: 'website',
  },
}
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Keep refrigerated (up to 14 days) or freeze for 3 months. Reheat in a dry skillet or wrapped in damp paper towels for 15 seconds. [Link to: /guides/how-to-store-tortillas]',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Our corn tortillas are certified gluten-free. Flour varieties contain wheat.',
      },
    },
    {
      '@type': 'Question',
    ...
    {
      '@type': 'Question',
      name: 'Do you ship to other California cities?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Absolutely! We deliver daily to Fresno, Los Angeles, Lancaster, and throughout CA, NV, and AZ.',
      },
    }
  ],
}
...
const localBusinessSchema = {
  '@context': 'https://schema.org',
  '@type': 'LocalBusiness',
  name: 'Lonestar Tortillas - Bakersfield Delivery',
  description: 'Authentic Texas tortillas delivered to Bakersfield, California',
  areaServed: {
    '@type': 'City',
    name: 'Bakersfield',
    containedInPlace: {
  ...
  url: 'https://lonestartortillas.com/locations/california/bakersfield',
        ...
        <header className="bg-charcoal-950 text-cream-50 py-12">
          <div className="container mx-auto px-6 max-w-6xl">
            ...
            <p className="text-xl text-cream-200 max-w-3xl">
              Get fresh H-E-B tortillas shipped directly to your door in Bakersfield, California. Experience the authentic taste of Texas.
            </p>
            <Link
              href="/shop"
        ...
        <article className="container mx-auto px-6 py-12 max-w-4xl prose prose-lg">
          ...
          <section className="bg-charcoal-950 text-cream-50 p-8 rounded-lg mt-12 text-center not-prose">
            ...
            <p className="text-lg mb-6 text-cream-200">
              Order authentic H-E-B tortillas delivered fresh to Bakersfield.
            </p>
            <Link
              href="/shop"
          ...
          <section className="mt-12 not-prose">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Link href="/locations/california/lancaster" className="px-4 py-2 bg-white border border-charcoal-200 rounded-lg text-charcoal-700 hover:border-sunset-500 hover:text-sunset-600 transition-colors text-sm">
                Lancaster
              </Link>
            </div>
          </section>
