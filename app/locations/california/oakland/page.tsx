...
export const metadata: Metadata = {
  title: 'Authentic Texas Tortillas Delivered to Oakland | Lonestar Tortillas',
  description: 'Get authentic H-E-B Texas tortillas shipped directly to Oakland, California. Fresh flour & corn tortillas for tacos, burritos & more. Fast shipping, premium quality.',
  keywords: 'tortillas Oakland, Texas tortillas California, H-E-B tortillas delivery, authentic Mexican tortillas Oakland, fresh tortillas shipped',
  alternates: {
    canonical: 'https://lonestartortillas.com/locations/california/oakland',
  },
  openGraph: {
    title: 'Texas Tortillas Delivered to Oakland | Lonestar Tortillas',
    description: 'Authentic H-E-B tortillas shipped fresh to Oakland. Experience the taste of Texas.',
    type: 'website',
  },
}
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Keep them refrigerated for up to 2 weeks or freeze for 3 months. For best results, reheat on a dry skillet or microwave wrapped in a damp towel. [Link to: /guides/how-to-store-tortillas]',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Our corn tortillas are 100% gluten-free. Flour and butter tortillas contain wheat.',
      },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes! We deliver statewide, including San Francisco, San Jose, Los Angeles, and Sacramento. We also serve Oregon and Nevada.',
      },
    }
  ],
}
...
const localBusinessSchema = {
  '@context': 'https://schema.org',
  '@type': 'LocalBusiness',
  name: 'Lonestar Tortillas - Oakland Delivery',
  description: 'Authentic Texas tortillas delivered to Oakland, California',
  areaServed: {
    '@type': 'City',
    name: 'Oakland',
    containedInPlace: {
  ...
  url: 'https://lonestartortillas.com/locations/california/oakland',
        ...
        <header className="bg-charcoal-950 text-cream-50 py-12">
          <div className="container mx-auto px-6 max-w-6xl">
            ...
            <p className="text-xl text-cream-200 max-w-3xl">
              Get fresh H-E-B tortillas shipped directly to your door in Oakland, California. Experience the authentic taste of Texas.
            </p>
            <Link
              href="/shop"
        ...
        <article className="container mx-auto px-6 py-12 max-w-4xl prose prose-lg">
          ...
          <section className="bg-charcoal-950 text-cream-50 p-8 rounded-lg mt-12 text-center not-prose">
            ...
            <p className="text-lg mb-6 text-cream-200">
              Order authentic H-E-B tortillas delivered fresh to Oakland.
            </p>
            <Link
              href="/shop"
          ...
          <section className="mt-12 not-prose">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Link href="/locations/california/san-jose" className="px-4 py-2 bg-white border border-charcoal-200 rounded-lg text-charcoal-700 hover:border-sunset-500 hover:text-sunset-600 transition-colors text-sm">
                San Jose
              </Link>
              <Link href="/locations/california/berkeley" className="px-4 py-2 bg-white border border-charcoal-200 rounded-lg text-charcoal-700 hover:border-sunset-500 hover:text-sunset-600 transition-colors text-sm">
                Berkeley
              </Link>
            </div>
          </section>
