...
export const metadata: Metadata = {
  title: 'Authentic Texas Tortillas Delivered to Santa Ana | Lonestar Tortillas',
  description: 'Get authentic H-E-B Texas tortillas shipped directly to Santa Ana, California. Fresh flour & corn tortillas for tacos, burritos & more. Fast shipping, premium quality.',
  keywords: 'tortillas Santa Ana, Texas tortillas California, H-E-B tortillas delivery, authentic Mexican tortillas Santa Ana, fresh tortillas shipped',
  alternates: {
    canonical: 'https://lonestartortillas.com/locations/california/santa-ana',
  },
  openGraph: {
    title: 'Texas Tortillas Delivered to Santa Ana | Lonestar Tortillas',
    description: 'Authentic H-E-B tortillas shipped fresh to Santa Ana. Experience the taste of Texas.',
    type: 'website',
  },
}
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Keep them in the fridge for up to 2 weeks or freeze for 3 months. [See our storage guide](/guides/how-to-store-tortillas) for tips!',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Our corn tortillas are 100% gluten-free. Flour varieties contain wheat.',
      },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes! We deliver statewide, including Los Angeles, San Diego, and everywhere between.',
      },
    }
  ],
}
...
const localBusinessSchema = {
  '@context': 'https://schema.org',
  '@type': 'LocalBusiness',
  name: 'Lonestar Tortillas - Santa Ana Delivery',
  description: 'Authentic Texas tortillas delivered to Santa Ana, California',
  areaServed: {
    '@type': 'City',
    name: 'Santa Ana',
    containedInPlace: {
  ...
  url: 'https://lonestartortillas.com/locations/california/santa-ana',
        ...
        <article className="container mx-auto px-6 py-12 max-w-4xl prose prose-lg">
          ...
          <section className="bg-charcoal-950 text-cream-50 p-8 rounded-lg mt-12 text-center not-prose">
            ...
            <p className="text-lg mb-6 text-cream-200">
              Order authentic H-E-B tortillas delivered fresh to Santa Ana.
            </p>
            <Link
              href="/shop"
