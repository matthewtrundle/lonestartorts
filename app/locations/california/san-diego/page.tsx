...
export const metadata: Metadata = {
  title: 'Authentic Texas Tortillas Delivered to San Diego | Lonestar Tortillas',
  description: 'Get authentic H-E-B Texas tortillas shipped directly to San Diego, California. Fresh flour & corn tortillas for tacos, burritos & more. Fast shipping, premium quality.',
  keywords: 'tortillas San Diego, Texas tortillas California, H-E-B tortillas delivery, authentic Mexican tortillas San Diego, fresh tortillas shipped',
  alternates: {
    canonical: 'https://lonestartortillas.com/locations/california/san-diego',
  },
  openGraph: {
    title: 'Texas Tortillas Delivered to San Diego | Lonestar Tortillas',
    description: 'Authentic H-E-B tortillas shipped fresh to San Diego. Experience the taste of Texas.',
    type: 'website',
  },
}
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'How long does shipping take to San Diego?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Most orders arrive within 2-3 business days. We ship via refrigerated carriers to ensure freshness from Texas to your table.',
      },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Absolutely! We deliver throughout California including Los Angeles, Anaheim, Riverside, and beyond.',
      },
    }
  ],
}
...
const localBusinessSchema = {
  '@context': 'https://schema.org',
  '@type': 'LocalBusiness',
  name: 'Lonestar Tortillas - San Diego Delivery',
  description: 'Authentic Texas tortillas delivered to San Diego, California',
  areaServed: {
    '@type': 'City',
    name: 'San Diego',
    containedInPlace: {
  ...
  url: 'https://lonestartortillas.com/locations/california/san-diego',
        ...
        <header className="bg-charcoal-950 text-cream-50 py-12">
          <div className="container mx-auto px-6 max-w-6xl">
            ...
            <p className="text-xl text-cream-200 max-w-3xl">
              Get fresh H-E-B tortillas shipped directly to your door in San Diego, California. Experience the authentic taste of Texas.
            </p>
            <Link
              href="/shop"
        ...
        <article className="container mx-auto px-6 py-12 max-w-4xl prose prose-lg">
          ...
          <section className="bg-charcoal-950 text-cream-50 p-8 rounded-lg mt-12 text-center not-prose">
            ...
            <p className="text-lg mb-6 text-cream-200">
              Order authentic H-E-B tortillas delivered fresh to San Diego.
            </p>
            <Link
              href="/shop"
