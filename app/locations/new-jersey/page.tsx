...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes! We offer free shipping on orders $80+ to New Jersey and all other US states. All orders ship free with our $80 minimum order.',
      },
    },
    {
      '@type': 'Question',
        ...
        <div className="bg-white p-8 rounded-lg shadow-md">
          ...
          <div className="space-y-4">
            ...
            <details className="group border border-charcoal-200 rounded-lg overflow-hidden">
              ...
              <div className="p-4 bg-white border-t border-charcoal-200">
                <p className="text-charcoal-700 leading-relaxed">Yes! We offer free shipping on orders $80+ to New Jersey and all other US states. All orders ship free with our $80 minimum order.</p>
              </div>
            </details>
            <details className="group border border-charcoal-200 rounded-lg overflow-hidden">
              <summary className="w-full flex items-center justify-between p-4 text-left bg-cream-50 hover:bg-cream-100 transition-colors cursor-pointer list-none">
