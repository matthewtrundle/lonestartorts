...
export const metadata: Metadata = {
  title: 'H-E-B Tortillas to Gresham',
  description: 'Get authentic H-E-B Texas tortillas shipped to Gresham, Oregon. Fast 2-3 day shipping to East Multnomah County.',
  alternates: { canonical: 'https://lonestartortillas.com/locations/oregon/gresham' },
}
    ...
    <div className="min-h-screen bg-gradient-to-b from-cream-50 to-masa-50">
      <header className="bg-charcoal-950 text-cream-50 py-12">
        <div className="container mx-auto px-6 max-w-6xl">
          <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Locations', href: '/locations' }, { label: 'Oregon', href: '/locations/oregon' }, { label: 'Gresham' }]} className="mb-6 text-cream-300" />
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Authentic Texas Tortillas Delivered to Gresham</h1>
          <p className="text-xl text-cream-200 max-w-3xl">Get fresh H-E-B tortillas shipped directly to Gresham.</p>
      ...
      <section className="max-w-6xl mx-auto px-6 py-8"><div className="relative w-full h-[300px] md:h-[400px] rounded-xl overflow-hidden shadow-lg"><Image src="/images/generated/hero-tortillas.webp" alt="Fresh tortillas delivered to Gresham" fill sizes="(max-width: 1152px) 100vw, 1152px" className="object-cover" priority /></div></section>
      <article className="container mx-auto px-6 py-12 max-w-4xl">
        <section className="prose prose-lg max-w-none mb-12">
          <h2 className="text-3xl font-bold text-charcoal-950 mb-6">Why Gresham Loves Texas Tortillas</h2>
          <p className="text-charcoal-700 leading-relaxed">Gresham's diverse community and proximity to Portland make it home to food lovers from across the country. As the fourth-largest city in Oregon, Gresham's growing population includes families who appreciate authentic ingredients for home cooking. We deliver H-E-B tortillas to Gresham and East Multnomah County.</p>
          ...
          <p className="text-charcoal-700 leading-relaxed mt-4">Our customers in Gresham tell us they love the convenience of having authentic Texas tortillas delivered right to their door. No more settling for grocery store alternatives when you can enjoy the real thing.</p>
        </section>
        <section className="bg-sunset-50 border-l-4 border-sunset-500 p-6 rounded-r-lg mb-12">
          <h2 className="text-xl font-bold text-charcoal-950 mb-2">Gresham Shipping Details</h2>
        ...
        <LocationFAQ city="Gresham" state="Oregon" />
        ...
        <section className="bg-charcoal-950 text-cream-50 p-8 rounded-lg mt-12 text-center">
          <h2 className="text-2xl font-bold mb-4">Ready to Taste Texas in Gresham?</h2>
