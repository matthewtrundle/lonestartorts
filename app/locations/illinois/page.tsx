...
const stateHero = locationHero('illinois')
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'How long does shipping to Illinois take?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Orders to Illinois typically arrive within 2-3 business days via USPS Priority Mail. We ship on Tuesdays, and order by Monday 9 PM CT to ship Tuesday. During peak seasons like holidays, delivery may take an extra day.',
      },
    },
    {
      '@type': 'Question',
      name: 'Are the tortillas fresh when they arrive in Illinois?',
      acceptedAnswer: {
        '@type': 'Answer',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes! We offer free shipping on orders $80+ to Illinois and all other US states. For smaller orders, our flat-rate shipping is $14.99. We use USPS Priority Mail to ensure fast, reliable delivery to every address in Illinois.',
      },
    },
    {
      '@type': 'Question',
      name: 'What types of H-E-B tortillas can I order to Illinois?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'We ship the full range of H-E-B tortillas to Illinois: corn tortillas (perfect for tacos and enchiladas), flour tortillas (great for burritos and quesadillas), and butter tortillas (the rich, buttery Texas favorite that\'s perfect for breakfast tacos). All varieties ship fresh and arrive ready to enjoy.',
      },
    },
    {
      '@type': 'Question',
    ...
    <>
      ...
      <section className="max-w-6xl mx-auto px-6 py-8">
        <div className="relative w-full h-[300px] md:h-[400px] rounded-xl overflow-hidden shadow-lg">
          <Image src="/images/generated/hero-tortillas.webp" alt="Fresh tortillas delivered to Illinois" fill sizes="(max-width: 1152px) 100vw, 1152px" className="object-cover" priority />
        </div>
      </section>
      ...
      <section className="container mx-auto px-6 py-12 max-w-4xl">
        ...
        <section className="bg-white p-8 rounded-lg shadow-md mb-12">
          <h2 className="text-2xl font-bold text-charcoal-950 mb-6">Illinois Tortilla Delivery FAQs</h2>
          <div className="space-y-4">
            <details className="group border border-charcoal-200 rounded-lg overflow-hidden" open>
              <summary className="w-full flex items-center justify-between p-4 text-left bg-cream-50 hover:bg-cream-100 transition-colors cursor-pointer list-none">
                <span className="font-semibold text-charcoal-950 pr-4">How long does shipping to Illinois take?</span>
              ...
              <div className="p-4 bg-white border-t border-charcoal-200">
                <p className="text-charcoal-700 leading-relaxed">
                  Orders to Illinois typically arrive within 2-3 business days via USPS Priority Mail.
            ...
            <details className="group border border-charcoal-200 rounded-lg overflow-hidden">
              <summary className="w-full flex items-center justify-between p-4 text-left bg-cream-50 hover:bg-cream-100 transition-colors cursor-pointer list-none">
                <span className="font-semibold text-charcoal-950 pr-4">Are the tortillas fresh when they arrive in Illinois?</span>
                <svg className="w-5 h-5 text-charcoal-600 flex-shrink-0 transition-transform group-open:rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </summary>
            ...
            <details className="group border border-charcoal-200 rounded-lg overflow-hidden">
              <summary className="w-full flex items-center justify-between p-4 text-left bg-cream-50 hover:bg-cream-100 transition-colors cursor-pointer list-none">
                <span className="font-semibold text-charcoal-950 pr-4">Do you offer free shipping to Illinois?</span>
                <svg className="w-5 h-5 text-charcoal-600 flex-shrink-0 transition-transform group-open:rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </summary>
            ...
            <details className="group border border-charcoal-200 rounded-lg overflow-hidden">
              <summary className="w-full flex items-center justify-between p-4 text-left bg-cream-50 hover:bg-cream-100 transition-colors cursor-pointer list-none">
                <span className="font-semibold text-charcoal-950 pr-4">What types of H-E-B tortillas can I order to Illinois?</span>
                <svg className="w-5 h-5 text-charcoal-600 flex-shrink-0 transition-transform group-open:rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </summary>
              <div className="p-4 bg-white border-t border-charcoal-200">
                <p className="text-charcoal-700 leading-relaxed">
                  We ship the full range of H-E-B tortillas to Illinois: corn tortillas (perfect for tacos and enchiladas),
            ...
            <details className="group border border-charcoal-200 rounded-lg overflow-hidden">
              ...
              <div className="p-4 bg-white border-t border-charcoal-200">
                <p className="text-charcoal-700 leading-relaxed">
                  ...
                  now you can enjoy them at home in Illinois. Many customers tell us it&apos;s a taste of Texas
      ...
      <section className="bg-charcoal-950 text-cream-50 py-12">
        <div className="container mx-auto px-6 max-w-4xl text-center">
          ...
          <Link href="/shop" className="bg-sunset-600 hover:bg-sunset-700 text-white px-8 py-3 rounded-lg font-bold transition-colors inline-block">Shop All Tortillas</Link>
        </div>
      </section>
    </div>
    </>
