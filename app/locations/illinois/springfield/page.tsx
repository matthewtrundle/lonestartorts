...
export const metadata: Metadata = {
  title: 'H-E-B Tortillas to Springfield, IL',
  description: 'Get authentic H-E-B Texas tortillas shipped to Springfield, Illinois. Fast 2-3 day shipping to the state capital.',
  alternates: { canonical: 'https://lonestartortillas.com/locations/illinois/springfield' },
}
    ...
    <div className="min-h-screen bg-gradient-to-b from-cream-50 to-masa-50">
      <header className="bg-charcoal-950 text-cream-50 py-12">
        <div className="container mx-auto px-6 max-w-6xl">
          <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Locations', href: '/locations' }, { label: 'Illinois', href: '/locations/illinois' }, { label: 'Springfield' }]} className="mb-6 text-cream-300" />
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Authentic Texas Tortillas Delivered to Springfield</h1>
          <p className="text-xl text-cream-200 max-w-3xl">Get fresh H-E-B tortillas shipped directly to Illinois' capital.</p>
      ...
      <article className="container mx-auto px-6 py-12 max-w-4xl">
        <section className="prose prose-lg max-w-none mb-12">
          ...
          <p className="text-charcoal-700 leading-relaxed">Lincoln's hometown knows good food—and state workers and families in Springfield are discovering that H-E-B tortillas are the best. Government employees who've transferred from Texas miss the taste of home. Now Central Illinois can enjoy authentic Texas tortillas without the 12-hour drive.</p>
          ...
          <p className="text-charcoal-700 leading-relaxed mt-4">Our customers in Springfield tell us they love the convenience of having authentic Texas tortillas delivered right to their door. No more settling for grocery store alternatives when you can enjoy the real thing.</p>
        </section>
        <section className="bg-sunset-50 border-l-4 border-sunset-500 p-6 rounded-r-lg mb-12">
          <h2 className="text-xl font-bold text-charcoal-950 mb-2">Springfield Shipping Details</h2>
        ...
        <LocationFAQ city="Springfield" state="Illinois" />
        ...
        <section className="bg-charcoal-950 text-cream-50 p-8 rounded-lg mt-12 text-center">
          <h2 className="text-2xl font-bold mb-4">Ready to Taste Texas in Springfield?</h2>
