...
export const metadata: Metadata = {
  title: 'H-E-B Tortillas to Aurora',
  description: 'Get authentic H-E-B Texas tortillas shipped to Aurora, Illinois. Fast 2-3 day shipping.',
  alternates: { canonical: 'https://lonestartortillas.com/locations/illinois/aurora' },
}
    ...
    <div className="min-h-screen bg-gradient-to-b from-cream-50 to-masa-50">
      <header className="bg-charcoal-950 text-cream-50 py-12">
        <div className="container mx-auto px-6 max-w-6xl">
          <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Locations', href: '/locations' }, { label: 'Illinois', href: '/locations/illinois' }, { label: 'Aurora' }]} className="mb-6 text-cream-300" />
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Authentic Texas Tortillas Delivered to Aurora</h1>
          <p className="text-xl text-cream-200 max-w-3xl">Get fresh H-E-B tortillas shipped directly to Aurora.</p>
      ...
      <section className="max-w-6xl mx-auto px-6 py-8"><div className="relative w-full h-[300px] md:h-[400px] rounded-xl overflow-hidden shadow-lg"><Image src="/images/generated/hero-tortillas.webp" alt="Fresh tortillas delivered to Aurora" fill sizes="(max-width: 1152px) 100vw, 1152px" className="object-cover" priority /></div></section>
      <article className="container mx-auto px-6 py-12 max-w-4xl">
        <section className="prose prose-lg max-w-none mb-12">
          <h2 className="text-3xl font-bold text-charcoal-950 mb-6">Why Aurora Loves Texas Tortillas</h2>
          <p className="text-charcoal-700 leading-relaxed">Aurora is Illinois' second-largest city with a diverse population that appreciates quality food. The city's growing Hispanic community and suburban families include many who've experienced the H-E-B difference during Texas visits. Now Aurora can enjoy authentic Texas tortillas at home.</p>
          ...
          <p className="text-charcoal-700 leading-relaxed mt-4">Our customers in Aurora tell us they love the convenience of having authentic Texas tortillas delivered right to their door. No more settling for grocery store alternatives when you can enjoy the real thing.</p>
        </section>
        ...
        <LocationFAQ city="Aurora" state="Illinois" />
