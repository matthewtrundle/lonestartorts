    ...
    <div className="min-h-screen bg-gradient-to-b from-cream-50 to-masa-50">
      <header className="bg-charcoal-950 text-cream-50 py-12">
        <div className="container mx-auto px-6 max-w-6xl">
          <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Locations', href: '/locations' }, { label: 'Massachusetts', href: '/locations/massachusetts' }, { label: 'Springfield' }]} className="mb-6 text-cream-300" />
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Authentic Texas Tortillas Delivered to Springfield</h1>
          <p className="text-xl text-cream-200 max-w-3xl">Get fresh H-E-B tortillas shipped directly to Western Massachusetts.</p>
      ...
      <article className="container mx-auto px-6 py-12 max-w-4xl">
        <section className="prose prose-lg max-w-none mb-12">
          ...
          <p className="text-charcoal-700 leading-relaxed">Springfield's diverse community and central New England location make it a hub for people from across the country. Western Massachusetts' largest city has a rich Hispanic heritage and appreciates authentic ingredients. We deliver H-E-B tortillas to Springfield and all of Hampden County.</p>
        ...
        <LocationFAQ city="Springfield" state="Massachusetts" />
