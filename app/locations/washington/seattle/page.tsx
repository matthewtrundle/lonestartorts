...
export const metadata: Metadata = {
  title: 'H-E-B Tortillas to Seattle',
  description: 'Get authentic H-E-B Texas tortillas shipped to Seattle, Washington. Fast shipping to the Emerald City.',
  alternates: { canonical: 'https://lonestartortillas.com/locations/washington/seattle' },
}
    ...
    <div className="min-h-screen bg-gradient-to-b from-cream-50 to-masa-50">
      <header className="bg-charcoal-950 text-cream-50 py-12">
        <div className="container mx-auto px-6 max-w-6xl">
          <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Locations', href: '/locations' }, { label: 'Washington', href: '/locations/washington' }, { label: 'Seattle' }]} className="mb-6 text-cream-300" />
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Authentic Texas Tortillas Delivered to Seattle</h1>
      ...
      <section className="max-w-6xl mx-auto px-6 py-8"><div className="relative w-full h-[300px] md:h-[400px] rounded-xl overflow-hidden shadow-lg"><Image src="/images/generated/hero-tortillas.webp" alt="Fresh tortillas delivered to Seattle" fill sizes="(max-width: 1152px) 100vw, 1152px" className="object-cover" priority /></div></section>
      <article className="container mx-auto px-6 py-12 max-w-4xl">
        <section className="prose prose-lg max-w-none mb-12">
          <h2 className="text-3xl font-bold text-charcoal-950 mb-6">Why Seattle Loves Texas Tortillas</h2>
          <p className="text-charcoal-700 leading-relaxed">Seattle's tech boom brought thousands of Texans to work at Amazon, Microsoft, and countless startups. These transplants miss H-E-B like nothing else. From Capitol Hill to Ballard, Seattle's foodies are discovering that authentic Texas tortillas are worth the cross-country shipping.</p>
          ...
          <p className="text-charcoal-700 leading-relaxed mt-4">Our customers in Seattle tell us they love the convenience of having authentic Texas tortillas delivered right to their door. No more settling for grocery store alternatives when you can enjoy the real thing.</p>
        </section>
        <section className="bg-sunset-50 border-l-4 border-sunset-500 p-6 rounded-r-lg mb-12">
          <h2 className="text-xl font-bold text-charcoal-950 mb-2">Seattle Shipping Details</h2>
        ...
        <LocationFAQ city="Seattle" state="Washington" />
