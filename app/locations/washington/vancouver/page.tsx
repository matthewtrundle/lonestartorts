...
export const metadata: Metadata = {
  title: 'H-E-B Tortillas to Vancouver, WA',
  description: 'Get authentic H-E-B Texas tortillas shipped to Vancouver, Washington. Fast shipping to Southwest Washington.',
  alternates: { canonical: 'https://lonestartortillas.com/locations/washington/vancouver' },
}
    ...
    <div className="min-h-screen bg-gradient-to-b from-cream-50 to-masa-50">
      <header className="bg-charcoal-950 text-cream-50 py-12">
        <div className="container mx-auto px-6 max-w-6xl">
          <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Locations', href: '/locations' }, { label: 'Washington', href: '/locations/washington' }, { label: 'Vancouver' }]} className="mb-6 text-cream-300" />
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Authentic Texas Tortillas Delivered to Vancouver</h1>
          <p className="text-xl text-cream-200 max-w-3xl">Get fresh H-E-B tortillas shipped directly to Vancouver, WA.</p>
      ...
      <section className="max-w-6xl mx-auto px-6 py-8"><div className="relative w-full h-[300px] md:h-[400px] rounded-xl overflow-hidden shadow-lg"><Image src="/images/generated/hero-tortillas.webp" alt="Fresh tortillas delivered to Vancouver WA" fill sizes="(max-width: 1152px) 100vw, 1152px" className="object-cover" priority /></div></section>
      <article className="container mx-auto px-6 py-12 max-w-4xl">
        <section className="prose prose-lg max-w-none mb-12">
          <h2 className="text-3xl font-bold text-charcoal-950 mb-6">Why Vancouver Loves Texas Tortillas</h2>
          <p className="text-charcoal-700 leading-relaxed">Vancouver, WA sits right across from Portland and attracts people seeking Washington's no-income-tax advantage. Many Texas transplants have discovered this gem, but they still miss their H-E-B. Now Clark County can enjoy authentic Texas tortillas delivered right across the Columbia.</p>
          ...
          <p className="text-charcoal-700 leading-relaxed mt-4">Our customers in Vancouver tell us they love the convenience of having authentic Texas tortillas delivered right to their door. No more settling for grocery store alternatives when you can enjoy the real thing.</p>
        </section>
        <section className="bg-sunset-50 border-l-4 border-sunset-500 p-6 rounded-r-lg mb-12">
          <h2 className="text-xl font-bold text-charcoal-950 mb-2">Vancouver Shipping Details</h2>
          <ul className="text-charcoal-700 space-y-2"><li><strong>Delivery Time:</strong> 3-4 business days</li><li><strong>Free Shipping:</strong> On orders $80+</li></ul>
        </section>
        ...
        <LocationFAQ city="Vancouver" state="Washington" />
        ...
        <section className="bg-charcoal-950 text-cream-50 p-8 rounded-lg mt-12 text-center">
          <h2 className="text-2xl font-bold mb-4">Ready to Taste Texas in Vancouver?</h2>
        ...
        <section className="mt-12">
          ...
          <div className="flex flex-wrap gap-3">
            <Link href="/locations/washington/seattle" className="px-4 py-2 bg-white border border-charcoal-200 rounded-lg text-charcoal-700 hover:border-sunset-500 hover:text-sunset-600 transition-colors">Seattle</Link>
