...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'How long does shipping to New York take?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Orders to New York typically arrive within 2-3 business days via USPS Priority Mail. We ship on Tuesdays, and order by Monday 9 PM CT to ship Tuesday. During peak seasons like holidays, delivery may take an extra day.',
      },
    },
    {
      '@type': 'Question',
      name: 'Are the tortillas fresh when they arrive in New York?',
      acceptedAnswer: {
        '@type': 'Answer',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes! We offer free shipping on orders $80+ to New York and all other US states. For smaller orders, our flat-rate shipping is $14.99. We use USPS Priority Mail to ensure fast, reliable delivery to every address in New York.',
      },
    },
    {
      '@type': 'Question',
      name: 'What types of H-E-B tortillas can I order to New York?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'We ship the full range of H-E-B tortillas to New York: corn tortillas (perfect for tacos and enchiladas), flour tortillas (great for burritos and quesadillas), and butter tortillas (the rich, buttery Texas favorite that\'s perfect for breakfast tacos). All varieties ship fresh and arrive ready to enjoy.',
      },
    },
    {
      '@type': 'Question',
      ...
      <main className="container mx-auto px-6 py-12 max-w-6xl">
        ...
        <section className="bg-sunset-50 border-l-4 border-sunset-500 p-6 rounded-r-lg mb-12">
          ...
          <p className="text-charcoal-700">
            <strong>Delivery Time:</strong> 2-3 business days to most New York addresses. Order by Monday 9 PM CT to ship Tuesday.
          </p>
        </section>
 ...
 {city.name} →
        ...
        <section className="bg-white p-8 rounded-lg shadow-md mb-12">
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-6">
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-sunset-600">$14.99</div>
