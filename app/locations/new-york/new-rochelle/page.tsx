...
export const metadata: Metadata = {
  title: 'H-E-B Tortillas to New Rochelle',
  description: 'Get authentic H-E-B Texas tortillas shipped directly to New Rochelle, New York. Fresh flour & corn tortillas. Fast 2-3 day shipping to Westchester.',
  keywords: 'tortillas New Rochelle, Texas tortillas Westchester, H-E-B tortillas delivery New Rochelle NY',
  alternates: { canonical: 'https://lonestartortillas.com/locations/new-york/new-rochelle' },
}
    ...
    <div className="min-h-screen bg-gradient-to-b from-cream-50 to-masa-50">
      <header className="bg-charcoal-950 text-cream-50 py-12">
        <div className="container mx-auto px-6 max-w-6xl">
          <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Locations', href: '/locations' }, { label: 'New York', href: '/locations/new-york' }, { label: 'New Rochelle' }]} className="mb-6 text-cream-300" />
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Authentic Texas Tortillas Delivered to New Rochelle</h1>
          <p className="text-xl text-cream-200 max-w-3xl">Get fresh H-E-B tortillas shipped directly to your door in New Rochelle and Westchester County.</p>
      ...
      <section className="max-w-6xl mx-auto px-6 py-8">
        <div className="relative w-full h-[300px] md:h-[400px] rounded-xl overflow-hidden shadow-lg">
          <Image src="/images/generated/hero-tortillas.webp" alt="Fresh authentic Texas tortillas delivered to New Rochelle" fill sizes="(max-width: 1152px) 100vw, 1152px" className="object-cover" priority />
        </div>
      </section>
      <article className="container mx-auto px-6 py-12 max-w-4xl">
        <section className="prose prose-lg max-w-none mb-12">
          <h2 className="text-3xl font-bold text-charcoal-950 mb-6">Why New Rochelle Loves Texas Tortillas</h2>
          <p className="text-charcoal-700 leading-relaxed">New Rochelle's suburban charm and proximity to NYC make it home to diverse families who appreciate quality food. Many residents have discovered that authentic Texas tortillas elevate their home cooking.</p>
          <p className="text-charcoal-700 leading-relaxed">H-E-B tortillas have been a Texas staple since 1905. Now Westchester residents can enjoy these premium tortillas without the long drive.</p>
        </section>
        <section className="bg-sunset-50 border-l-4 border-sunset-500 p-6 rounded-r-lg mb-12">
          <h2 className="text-xl font-bold text-charcoal-950 mb-2">New Rochelle Shipping Details</h2>
        ...
        <LocationFAQ city="New Rochelle" state="New York" />
        ...
        <section className="bg-charcoal-950 text-cream-50 p-8 rounded-lg mt-12 text-center">
          <h2 className="text-2xl font-bold mb-4">Ready to Taste Texas in New Rochelle?</h2>
