...
export const metadata: Metadata = {
  title: 'H-E-B Tortillas to Yonkers',
  description: 'Get authentic H-E-B Texas tortillas shipped directly to Yonkers, New York. Fresh flour & corn tortillas. Fast 2-3 day shipping to Westchester County.',
  keywords: 'tortillas Yonkers, Texas tortillas Westchester, H-E-B tortillas delivery Yonkers NY, authentic Mexican tortillas',
  alternates: { canonical: 'https://lonestartortillas.com/locations/new-york/yonkers' },
}
    ...
    <div className="min-h-screen bg-gradient-to-b from-cream-50 to-masa-50">
      <header className="bg-charcoal-950 text-cream-50 py-12">
        <div className="container mx-auto px-6 max-w-6xl">
          <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Locations', href: '/locations' }, { label: 'New York', href: '/locations/new-york' }, { label: 'Yonkers' }]} className="mb-6 text-cream-300" />
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Authentic Texas Tortillas Delivered to Yonkers</h1>
          <p className="text-xl text-cream-200 max-w-3xl">Get fresh H-E-B tortillas shipped directly to your door in Yonkers and Westchester County.</p>
      ...
      <section className="max-w-6xl mx-auto px-6 py-8">
        <div className="relative w-full h-[300px] md:h-[400px] rounded-xl overflow-hidden shadow-lg">
          <Image src="/images/generated/hero-tortillas.webp" alt="Fresh authentic Texas tortillas delivered to Yonkers" fill sizes="(max-width: 1152px) 100vw, 1152px" className="object-cover" priority />
        </div>
      </section>
      <article className="container mx-auto px-6 py-12 max-w-4xl">
        <section className="prose prose-lg max-w-none mb-12">
          <h2 className="text-3xl font-bold text-charcoal-950 mb-6">Why Yonkers Loves Texas Tortillas</h2>
          <p className="text-charcoal-700 leading-relaxed">Yonkers, New York's fourth-largest city, sits just north of the Bronx and is home to a diverse population that appreciates quality food. Many residents have discovered that authentic Texas tortillas are a game-changer for home cooking.</p>
          <p className="text-charcoal-700 leading-relaxed">H-E-B has been making premium tortillas in Texas since 1905. Now Yonkers residents can enjoy these same beloved tortillas delivered right to their Westchester doorstep.</p>
        </section>
        <section className="bg-sunset-50 border-l-4 border-sunset-500 p-6 rounded-r-lg mb-12">
          <h2 className="text-xl font-bold text-charcoal-950 mb-2">Yonkers Shipping Details</h2>
        ...
        <LocationFAQ city="Yonkers" state="New York" />
        ...
        <section className="bg-charcoal-950 text-cream-50 p-8 rounded-lg mt-12 text-center">
          <h2 className="text-2xl font-bold mb-4">Ready to Taste Texas in Yonkers?</h2>
