...
export const metadata: Metadata = {
  title: 'H-E-B Tortillas to Mount Vernon',
  description: 'Get authentic H-E-B Texas tortillas shipped directly to Mount Vernon, New York. Fresh flour & corn tortillas. Fast 2-3 day shipping.',
  keywords: 'tortillas Mount Vernon, Texas tortillas Westchester, H-E-B tortillas delivery Mount Vernon NY',
  alternates: { canonical: 'https://lonestartortillas.com/locations/new-york/mount-vernon' },
}
    ...
    <div className="min-h-screen bg-gradient-to-b from-cream-50 to-masa-50">
      <header className="bg-charcoal-950 text-cream-50 py-12">
        <div className="container mx-auto px-6 max-w-6xl">
          <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Locations', href: '/locations' }, { label: 'New York', href: '/locations/new-york' }, { label: 'Mount Vernon' }]} className="mb-6 text-cream-300" />
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Authentic Texas Tortillas Delivered to Mount Vernon</h1>
          <p className="text-xl text-cream-200 max-w-3xl">Get fresh H-E-B tortillas shipped directly to your door in Mount Vernon.</p>
      ...
      <section className="max-w-6xl mx-auto px-6 py-8">
        <div className="relative w-full h-[300px] md:h-[400px] rounded-xl overflow-hidden shadow-lg">
          <Image src="/images/generated/hero-tortillas.webp" alt="Fresh authentic Texas tortillas delivered to Mount Vernon" fill sizes="(max-width: 1152px) 100vw, 1152px" className="object-cover" priority />
        </div>
      </section>
      <article className="container mx-auto px-6 py-12 max-w-4xl">
        <section className="prose prose-lg max-w-none mb-12">
          <h2 className="text-3xl font-bold text-charcoal-950 mb-6">Why Mount Vernon Loves Texas Tortillas</h2>
          <p className="text-charcoal-700 leading-relaxed">Mount Vernon, just north of the Bronx, is a diverse community that appreciates authentic flavors. Finding genuine Texas tortillas in Westchester County used to be impossible - until now.</p>
          <p className="text-charcoal-700 leading-relaxed">H-E-B has been making premium tortillas since 1905. Now Mount Vernon residents can enjoy these beloved Texas staples delivered right to their door.</p>
        </section>
        <section className="bg-sunset-50 border-l-4 border-sunset-500 p-6 rounded-r-lg mb-12">
          <h2 className="text-xl font-bold text-charcoal-950 mb-2">Mount Vernon Shipping Details</h2>
        ...
        <LocationFAQ city="Mount Vernon" state="New York" />
        ...
        <section className="bg-charcoal-950 text-cream-50 p-8 rounded-lg mt-12 text-center">
          <h2 className="text-2xl font-bold mb-4">Ready to Taste Texas in Mount Vernon?</h2>
