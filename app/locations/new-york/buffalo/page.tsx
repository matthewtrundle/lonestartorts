...
export const metadata: Metadata = {
  title: 'Authentic Texas Tortillas Delivered to Buffalo | Lonestar Tortillas',
  description: 'Get authentic H-E-B Texas tortillas shipped directly to Buffalo, New York. Fresh flour & corn tortillas for tacos, burritos & more. Fast 2-3 day shipping to Western NY.',
  keywords: 'tortillas Buffalo, Texas tortillas Western NY, H-E-B tortillas delivery Buffalo, authentic Mexican tortillas Buffalo NY, fresh tortillas shipped',
  alternates: {
    canonical: 'https://lonestartortillas.com/locations/new-york/buffalo',
  },
}
...
const localBusinessSchema = {
  ...
  '@type': 'LocalBusiness',
  name: 'Lonestar Tortillas - Buffalo Delivery',
  description: 'Authentic Texas tortillas delivered to Buffalo and Western New York',
  areaServed: { '@type': 'City', name: 'Buffalo', containedInPlace: { '@type': 'State', name: 'New York' } },
  url: 'https://lonestartortillas.com/locations/new-york/buffalo',
  priceRange: '$$',
}
      ...
      <div className="min-h-screen bg-gradient-to-b from-cream-50 to-masa-50">
        <header className="bg-charcoal-950 text-cream-50 py-12">
          <div className="container mx-auto px-6 max-w-6xl">
            <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Locations', href: '/locations' }, { label: 'New York', href: '/locations/new-york' }, { label: 'Buffalo' }]} className="mb-6 text-cream-300" />
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Authentic Texas Tortillas Delivered to Buffalo</h1>
            <p className="text-xl text-cream-200 max-w-3xl">Get fresh H-E-B tortillas shipped directly to your door in Buffalo and throughout Western New York.</p>
        ...
        <section className="max-w-6xl mx-auto px-6 py-8">
          <div className="relative w-full h-[300px] md:h-[400px] rounded-xl overflow-hidden shadow-lg">
            <Image src="/images/generated/hero-tortillas.webp" alt="Fresh authentic Texas tortillas delivered to Buffalo" fill className="object-cover" priority />
          </div>
        </section>

        <article className="container mx-auto px-6 py-12 max-w-4xl">
          <section className="prose prose-lg max-w-none mb-12">
            <h2 className="text-3xl font-bold text-charcoal-950 mb-6">Why Buffalo Loves Texas Tortillas</h2>
            <p className="text-charcoal-700 leading-relaxed">Buffalo is known for its wings, but the city's food scene has grown to embrace cuisines from around the world. Among the residents are Texans who relocated for work at the area's universities and hospitals, bringing their love for authentic tortillas with them.</p>
            <p className="text-charcoal-700 leading-relaxed">H-E-B has been perfecting tortilla recipes in Texas since 1905. Now Buffalo residents can enjoy these same premium tortillas without making the 1,500-mile trip to the Lone Star State.</p>
          </section>

          <section className="bg-sunset-50 border-l-4 border-sunset-500 p-6 rounded-r-lg mb-12">
            <h2 className="text-xl font-bold text-charcoal-950 mb-2">Buffalo Shipping Details</h2>
          ...
          <section className="bg-charcoal-950 text-cream-50 p-8 rounded-lg mt-12 text-center">
            <h2 className="text-2xl font-bold mb-4">Ready to Taste Texas in Buffalo?</h2>
            <p className="text-lg mb-6 text-cream-200">Order authentic H-E-B tortillas delivered fresh to Western New York.</p>
