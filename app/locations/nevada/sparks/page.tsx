...
export const metadata: Metadata = {
  title: 'H-E-B Tortillas to Sparks',
  description: 'Get authentic H-E-B Texas tortillas shipped to Sparks, Nevada. Fast 2-3 day shipping.',
  alternates: { canonical: 'https://lonestartortillas.com/locations/nevada/sparks' },
}
    ...
    <div className="min-h-screen bg-gradient-to-b from-cream-50 to-masa-50">
      <header className="bg-charcoal-950 text-cream-50 py-12">
        <div className="container mx-auto px-6 max-w-6xl">
          <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Locations', href: '/locations' }, { label: 'Nevada', href: '/locations/nevada' }, { label: 'Sparks' }]} className="mb-6 text-cream-300" />
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Authentic Texas Tortillas Delivered to Sparks</h1>
          <p className="text-xl text-cream-200 max-w-3xl">Get fresh H-E-B tortillas shipped directly to Sparks.</p>
      ...
      <section className="max-w-6xl mx-auto px-6 py-8"><div className="relative w-full h-[300px] md:h-[400px] rounded-xl overflow-hidden shadow-lg"><Image src="/images/generated/hero-tortillas.webp" alt="Fresh tortillas delivered to Sparks" fill sizes="(max-width: 1152px) 100vw, 1152px" className="object-cover" priority /></div></section>
      <article className="container mx-auto px-6 py-12 max-w-4xl">
        <section className="prose prose-lg max-w-none mb-12">
          <h2 className="text-3xl font-bold text-charcoal-950 mb-6">Why Sparks Loves Texas Tortillas</h2>
          <p className="text-charcoal-700 leading-relaxed">Sparks' industrial growth has brought workers from across the country to the Tahoe-Reno Industrial Center. Many came from Texas and miss the taste of home. Whether you work at the Tesla Gigafactory or just love good tortillas, Sparks now has access to authentic H-E-B products.</p>
          ...
          <p className="text-charcoal-700 leading-relaxed mt-4">Our customers in Sparks tell us they love the convenience of having authentic Texas tortillas delivered right to their door. No more settling for grocery store alternatives when you can enjoy the real thing.</p>
        </section>
        <section className="bg-sunset-50 border-l-4 border-sunset-500 p-6 rounded-r-lg mb-12">
          <h2 className="text-xl font-bold text-charcoal-950 mb-2">Sparks Shipping Details</h2>
        ...
        <LocationFAQ city="Sparks" state="Nevada" />
