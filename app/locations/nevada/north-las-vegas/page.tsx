...
export const metadata: Metadata = {
  title: 'H-E-B Tortillas to North Las Vegas',
  description: 'Get authentic H-E-B Texas tortillas shipped to North Las Vegas, Nevada. Fast 2-3 day shipping.',
  alternates: { canonical: 'https://lonestartortillas.com/locations/nevada/north-las-vegas' },
}
    ...
    <div className="min-h-screen bg-gradient-to-b from-cream-50 to-masa-50">
      <header className="bg-charcoal-950 text-cream-50 py-12">
        <div className="container mx-auto px-6 max-w-6xl">
          <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Locations', href: '/locations' }, { label: 'Nevada', href: '/locations/nevada' }, { label: 'North Las Vegas' }]} className="mb-6 text-cream-300" />
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Authentic Texas Tortillas Delivered to North Las Vegas</h1>
          <p className="text-xl text-cream-200 max-w-3xl">Get fresh H-E-B tortillas shipped directly to North Las Vegas.</p>
      ...
      <section className="max-w-6xl mx-auto px-6 py-8"><div className="relative w-full h-[300px] md:h-[400px] rounded-xl overflow-hidden shadow-lg"><Image src="/images/generated/hero-tortillas.webp" alt="Fresh tortillas delivered to North Las Vegas" fill sizes="(max-width: 1152px) 100vw, 1152px" className="object-cover" priority /></div></section>
      <article className="container mx-auto px-6 py-12 max-w-4xl">
        <section className="prose prose-lg max-w-none mb-12">
          <h2 className="text-3xl font-bold text-charcoal-950 mb-6">Why North Las Vegas Loves Texas Tortillas</h2>
          <p className="text-charcoal-700 leading-relaxed">North Las Vegas is one of America's fastest-growing cities, with affordable housing attracting families from across the country. The city's diverse community includes many Texas transplants who work on the Strip but live in NLV. Now they can enjoy authentic H-E-B tortillas at home.</p>
          ...
          <p className="text-charcoal-700 leading-relaxed mt-4">Our customers in North Las Vegas tell us they love the convenience of having authentic Texas tortillas delivered right to their door. No more settling for grocery store alternatives when you can enjoy the real thing.</p>
        </section>
        <section className="bg-sunset-50 border-l-4 border-sunset-500 p-6 rounded-r-lg mb-12">
          <h2 className="text-xl font-bold text-charcoal-950 mb-2">North Las Vegas Shipping Details</h2>
        ...
        <LocationFAQ city="North Las Vegas" state="Nevada" />
        ...
        <section className="bg-charcoal-950 text-cream-50 p-8 rounded-lg mt-12 text-center">
          <h2 className="text-2xl font-bold mb-4">Ready to Taste Texas in North Las Vegas?</h2>
        ...
        <section className="mt-12">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/locations/nevada/sparks" className="px-4 py-2 bg-white border border-charcoal-200 rounded-lg text-charcoal-700 hover:border-sunset-500 hover:text-sunset-600 transition-colors">Sparks</Link>
