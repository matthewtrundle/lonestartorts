...
const blogPosts: BlogPost[] = [
  {
    ...
    slug: 'corn-vs-flour-guide',
    excerpt: 'Comprehensive guide comparing corn, flour, and specialty tortillas. Learn which tortilla is best for tacos, burritos, quesadillas, and more.',
    category: 'Product Education',
    readTime: '12 min read',
    date: 'February 3, 2026',
    image: '/images/blog/corn-vs-flour-hero.webp',
  },
  {
    title: 'The Ultimate Texas Breakfast Taco Guide',
    slug: 'texas-breakfast-taco-guide',
    excerpt: 'Master the art of Texas breakfast tacos with our comprehensive guide. Recipes, tortilla pairings, and tips from Austin to San Antonio.',
    category: 'Recipes & Culture',
    readTime: '14 min read',
    date: 'February 3, 2026',
    image: '/images/blog/breakfast-taco-hero.webp',
  },
  {
    title: 'How to Store Tortillas: Keep Them Fresh for Weeks',
    slug: 'how-to-store-tortillas',
    excerpt: 'Complete guide to storing tortillas. Learn proper storage methods for corn and flour tortillas, freezing tips, and how to revive stale tortillas.',
    category: 'Guides',
    readTime: '10 min read',
    date: 'February 3, 2026',
    image: '/images/blog/tortilla-storage-hero.webp',
  },
  {
    title: 'Mission Tortillas: A San Antonio Legacy',
    slug: 'mission-tortillas-san-antonio',
    excerpt: 'Discover the story of Mission Foods, the San Antonio-born tortilla company that became a global brand. Learn why Mission tortillas are trusted by Texans.',
    category: 'Brand Story',
    readTime: '11 min read',
    date: 'February 3, 2026',
    image: '/images/blog/mission-tortillas-hero.webp',
  },
  {
    title: 'Street Tacos at Home: Master Taqueria Style',
    slug: 'street-tacos-at-home',
    excerpt: 'Learn to make authentic street tacos at home like a real taqueria. Complete recipes for carne asada, carnitas, and al pastor with traditional toppings.',
    category: 'Recipes',
    readTime: '13 min read',
    date: 'February 3, 2026',
    image: '/images/blog/street-tacos-hero.webp',
  },
  {
...
const CategoryBadge = ({ category }: { category: string }) => {
  const colors: { [key: string]: string } = {
    ...
    'Product Education': 'bg-blue-100 text-blue-700',
    'Guides': 'bg-green-100 text-green-700',
    'Brand Story': 'bg-purple-100 text-purple-700',
