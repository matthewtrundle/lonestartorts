...
export const metadata: Metadata = {
  title: 'Science of Nixtamalization',
...
const articleSchema = {
  ...
  image: 'https://lonestartortillas.com/images/generated/blog-nixtamalization-science.webp',
  mainEntityOfPage: 'https://lonestartortillas.com/blog/nixtamalization-science',
};
        ...
        <article className="container mx-auto px-6 py-12 max-w-3xl">
          ...
          <section className="mt-12 border-t border-charcoal-200 pt-8">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              ...
              <Link href="/blog/brisket-breakfast-burrito" className="block p-4 bg-white rounded-lg border border-charcoal-100 hover:border-sunset-500 hover:shadow-md transition-all">
                <h3 className="font-bold text-charcoal-950 hover:text-sunset-600">The Ultimate Brisket Breakfast Burrito</h3>
              </Link>
            </div>
          </section>
