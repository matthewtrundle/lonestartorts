...
export const metadata: Metadata = {
  ...
  description:
    'Texas favorites beyond tortillas — authentic H-E-B salsas, sauces, seasonings, and more, shipped nationwide. Ships with tortilla orders or $14.99 alone.',
          ...
          <div className="text-center mb-12">
            ...
            <div className="flex justify-center gap-6 mb-6">
              ...
              <div className="flex items-center gap-2 text-sm text-gray-600">
                ...
                <span>Ships with tortilla orders or $14.99 alone</span>
              </div>
            </div>
          </div>
