...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Texas Exes: get authentic H-E-B tortillas shipped anywhere in the US. Chapter bulk discounts up to 20% off.',
    type: 'website',
  },
};
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "No chapter, no problem! Head to our shop to order individual packs. FREE shipping on orders $80+!",
  },
  {
