...
const recipes = [
  ...
  {
    title: 'Brisket Breakfast Burrito',
    description: 'The ultimate Texas breakfast: smoked brisket, eggs, cheese, and crispy potatoes wrapped in H-E-B® flour tortillas. Perfect for using leftover brisket.',
    href: '/recipes/brisket-breakfast-burrito',
    image: '/images/recipes/brisket-breakfast-burrito.webp',
    totalTime: '35 min',
    difficulty: 'Easy' as const,
    servings: '4 servings',
    category: 'Breakfast',
  },
  {
    ...
    image: '/images/recipes/brisket-quesadillas.webp',
    totalTime: '25 min',
    difficulty: 'Easy' as const,
    servings: '4 servings',
    category: 'Lunch',
  ...
  {
    title: 'Texas Smoked Brisket Tacos',
    description: 'Juicy smoked brisket tacos with pickled onions and cilantro on H-E-B® flour tortillas. Perfect for using leftover brisket.',
    href: '/recipes/brisket-tacos',
    image: '/images/recipes/brisket-tacos.webp',
    totalTime: '25 min',
    difficulty: 'Easy' as const,
    servings: '6 servings',
    category: 'Dinner',
