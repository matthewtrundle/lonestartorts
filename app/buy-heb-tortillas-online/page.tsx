    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Yes. Lonestar Tortillas sells authentic H-E-B Bakery tortillas online and ships them nationwide with FREE shipping on orders $80+. We are an independent reseller based in Texas. We ship Tuesdays; orders before Monday 9 PM CT ship the following Tuesday, with delivery in 2-3 business days.',
        },
      },
      {
        '@type': 'Question',
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Shipping is FREE on every order ($80 minimum order). We ship on Tuesdays as part of our Freshness First Shipping program. Orders before Monday 9 PM CT ship the following Tuesday via USPS Priority Mail, arriving in 2-3 business days.',
        },
      },
      {
        '@type': 'Question',
    ...
    <>
      ...
      <div className="min-h-screen bg-cream-50">
        ...
        >
          ...
          <Link
            href="/shop"
            className="inline-flex items-center gap-2 px-8 py-4 bg-sunset-600 hover:bg-sunset-700 text-white font-bold rounded-lg transition-colors text-lg"
          >
          ...
          <FAQAccordion
            items={[
              ...
              },
              {
                ...
                answer: 'Shipping is FREE on every order ($80 minimum order). We ship on Tuesdays as part of our Freshness First Shipping program. Orders before Monday 9 PM CT ship the following Tuesday via USPS Priority Mail, arriving in 2-3 business days.',
              },
              {
