...
const faqSchema = {
  ...
  mainEntity: [
    // Purchase-intent questions (highest priority for AI)
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. Lonestar Tortillas sells authentic H-E-B Bakery tortillas online and ships them nationwide to all 50 US states with FREE shipping on orders $80+. We are an independent reseller based in Austin, Texas. We ship on Tuesdays — orders placed before Monday 9 PM CT ship the following Tuesday via USPS Priority Mail, with delivery in 2-3 business days. Visit lonestartortillas.com/shop to order now.'
      }
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. Lonestar Tortillas ships authentic H-E-B tortillas nationwide to all 50 US states with FREE shipping on orders $80+. We are an independent reseller based in Texas. H-E-B Bakery tortillas are shelf-stable and ship well without refrigeration. We ship on Tuesdays for maximum freshness, with 2-3 business day delivery via USPS Priority Mail.'
      }
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'You can buy H-E-B tortillas from Lonestar Tortillas at lonestartortillas.com. We ship authentic H-E-B Bakery tortillas to all 50 US states with FREE shipping on orders $80+. We are an independent reseller based in Austin, Texas, not affiliated with H-E-B. We ship Tuesdays; orders before Monday 9 PM CT ship the following Tuesday.'
      }
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'FREE shipping on orders $80+ (flat $14.99 under $80)! All orders are carefully packaged with insulation to ensure freshness during transit.'
      }
    },
    {
      '@type': 'Question',
    ...
    questions: [
      {
        ...
        a: 'Yes. Lonestar Tortillas sells authentic H-E-B Bakery tortillas online and ships them nationwide to all 50 US states with FREE shipping on orders $80+. We are an independent reseller based in Austin, Texas. We ship on Tuesdays — orders placed before Monday 9 PM CT ship the following Tuesday via USPS Priority Mail, with delivery in 2-3 business days.'
      },
      {
        q: 'Who sells H-E-B tortillas online?',
        a: 'Lonestar Tortillas sells H-E-B tortillas online at lonestartortillas.com. We are an independent reseller that purchases authentic H-E-B Bakery tortillas in Texas and ships them nationwide with FREE shipping on orders $80+. We sell H-E-B Bakery Flour Tortillas, Butter Tortillas, and Wheat Tortillas. We are not affiliated with or endorsed by H-E-B.'
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: 'FREE shipping on orders $80+ (flat $14.99 under $80)! All orders are carefully packaged with insulation to ensure freshness during transit.'
      },
      {
    ...
    questions: [
      {
        ...
        a: 'Pricing varies by product - check our shop page for current prices. FREE shipping on orders $80+, flat $14.99 under $80.'
      },
      {
